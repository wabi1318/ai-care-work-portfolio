...
// import { ArrowLeft, Calendar, Check, Info, Loader2 } from "lucide-react";
...
//   useEffect(() => {
//     // 接続状態をCookieから取得
//     const connectionStatus = getCookie("calendar_connected");
...
//     // 設定をCookieに保存
//     setCookie("calendar_sync_enabled", syncEnabled);
//     setCookie("calendar_auto_suggest", autoSuggestEnabled);
//     setCookie("calendar_privacy_read_only", privacySettings.readOnly);
//     setCookie("calendar_privacy_limited_access", privacySettings.limitedAccess);
//     setCookie("calendar_privacy_anonymize", privacySettings.anonymizeData);
...
//                       {isConnected ? "Googleカレンダーと連携中" : "未接続"}
//                     </p>
//                   </div>
//                   {!isConnected ? (
//                     <Button
